...
const AddJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.msg || "Failed to add job. Please try again."
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="bg-transparent w-full min-h-[90vh] flex justify-center items-start pt-10 px-4 sm:px-6 lg:px-8">
      <div className="content w-full max-w-2xl min-h-[300px] border border-gray-200 rounded-xl shadow bg-white p-4 sm:p-5">
        <div className="title text-lg sm:text-xl font-medium mb-4">
        ...
        <form onSubmit={handleSubmit}>
          <div className="inputs grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            <div className="position flex flex-col">
              ...
              <input
                ...
                className="border border-gray-200 rounded-[8px] px-2 py-1 mt-1 placeholder:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="position flex flex-col">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 px-2 py-1.5 text-[14px] border border-gray-200 rounded-[8px] focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
          ...
          <div className="buttons mt-6 flex flex-col sm:flex-row justify-end gap-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 border border-blue-100 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
